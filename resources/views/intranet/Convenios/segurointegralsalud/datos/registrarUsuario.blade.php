...
<div id="response">
    <h1 class="page-header">Usuarios
        <small>Aqui puedo agregar usuarios</small>
    </h1>
    <!-- final cabecera -->
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                    ...
                    <div class="col-xl-3 ">
                        ...
                        <input id="appaterno" type="text" class="form-control" autocomplete="off" onchange="generarUsuario()"  onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                    ...
                    <div class="col-xl-3 ">
                        ...
                        <input id="apmaterno" type="text" class="form-control" autocomplete="off" onchange="generarUsuario()"  onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                    ...
                    <div class="col-xl-3 ">
                        ...
                        <input id="pnombre" type="text" class="form-control " autocomplete="off" onchange="generarUsuario()"  onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                        <div class="hide " id="valpnombre"></div>
                    </div>
                    <div class="col-xl-3 ">
                        <label for="snombre">SNOMBRE</label>
                        <input id="snombre" type="text" class="form-control" autocomplete="off" onchange="generarUsuario()"  onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                ...
                <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                    ...
                    <div class="col-xl-3 ">
                        ...
                        <input id="dir" type="text" class="form-control "  onkeyup="javascript:this.value=this.value.toUpperCase();"/>
                        <div id="dirval"></div>
                    </div>
                </div>
                <br>
                <div class="col-xl-12 col-sm-12 col-xs-12 row">
                    ...
                    <div class="col-xl-3 ">
                        <label for="provacte">PROVINCIA<req>*</req></label>
                    ...
                    <div class="col-xl-3 ">
                        <label for="disacte">DISTRITO<req>*</req></label>
                    ...
                    <div class="col-xl-3 ">
                        <label for="estate">ESTABLECIMIENTO<req>*</req></label>
                ...
                <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                    ...
                    <div class="col-xl-3 ">
                        <label for="nombrecu"> NOMBRE DE CUENTA<req>*</req></label>
