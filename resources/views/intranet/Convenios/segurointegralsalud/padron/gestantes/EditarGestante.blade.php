...
<div id="response">
    ...
    <div class="panel panel-inverse">
        <div class="panel-heading">
            ...
            <h1 class="panel-title">EDITAR GESTANTE </h1>
        ...
        <div class="panel-body">
            <legend class="m-b-15">DATOS PERSONA</legend>
            <input id="idpersona" value="{{$gestante->idPersona}}" hidden>
            <input id="idgestante" value="{{$gestante->idGestante}}" hidden>
            <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                ...
                <input id="tipodocb" value="{{$gestante->tipoDoc}}" hidden>
                <div class="col-xl-3 ">
                    <label for="dni">N° DOC</label>
                    <input id="dni" type="number" class="form-control  " autocomplete="off"
                           onchange="validarDniExpress()" value="{{$gestante->numeroDoc}}"/>
                ...
                <div class="col-xl-3 ">
                    ...
                    <input id="telefo" type="number" class="form-control" onchange="validarCelular()"
                           autocomplete="off" value="{{$gestante->telefono}}"/>
            ...
            <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                ...
                <input id="iddepa" value="{{$gestante->dep}}" hidden>
                <div class="col-xl-3 ">
                    ...
                    <input id="idprovb" value="{{$gestante->idProvincia}}" hidden>
                ...
                <input id="iddisb" value="{{$gestante->idDistrito}}" hidden>
                <div class="col-xl-3 ">
                    <label for="dir">DIRECCION</label>
                    <input id="dir" type="text" class="form-control " value="{{$gestante->direccion}}"/>
                    <div id="dirval"></div>
                </div>
                ...
                <div class="col-xl-3 ">
                    ...
                    <input type="text" class="form-control m-b-5 typeahead" id="cenpo"
                           name="cenpo" autocomplete="off" value="{{$gestante->idCentroPoblado}}">
                    <div id="cenpoval"></div>
                </div>
                <script>
                    $('#cenpo').typeahead({
                ...
                <div class="col-xl-6">
                    ...
                    <input id="ref" type="text" class="form-control" value="{{$gestante->referencia}}"/>
                ...
                <input id="etniabu" value="{{$gestante->etnia}}" hidden>
            </div>
            <br>
            <div class="col-xl-12 col-sm-12 col-xs-12 row">
                ...
                <input id="provacteb" value="{{$gestante->provest}}" hidden>
                <div class="col-xl-3 ">
                    <label for="disacte">DISTRITO</label>
                    <select id="disacte" class="form-control">
                        <option selected value="0">SELECCIONE</option>
                    </select>
                    <div id="valdisacte"></div>
                </div>

                <input id="disacteb" value="{{$gestante->disest}}" hidden>
                <div class="col-xl-3 ">
                    <label for="estate">ESTABLECIMIENTO</label>
                    <select id="estate" class="form-control">
                        <option selected value="0">SELECCIONE</option>
                    </select>
                    <div id="valestate"></div>
                </div>
                <input id="estateb" value="{{$gestante->estab}}" hidden>
            </div>
            <br>
            ...
            <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                <div class="col-xl-3 ">
                    ...
                    <input id="nrohistoria" type="text" class="form-control " value="{{$gestante->nroHistoria}}"/>
                ...
                <input id="tipsegb" value="{{$gestante->tipoSeguro}}" hidden>
                <div class="col-xl-4 ">
                ...
                <input id="nivinstrb" value="{{$gestante->nivelinstruc}}" hidden>
                <div class="col-xl-3 ">
                ...
                <input id="idiomb" value="{{$gestante->Lengua}}" hidden>
                <div class="col-xl-3 ">
                ...
                <input id="estacivb" value="{{$gestante->estadoCivil}}" hidden="">
            </div>
            <br>
            ...
            <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                ...
                <div class="col-xl-3 ">
                    ...
                    <input id="gest" type="text" class="form-control " value="{{$gestante->gesta}}"/>
                    <div id="valgest"></div>

                </div>
                <div class="col-xl-3 ">
                    <label for="pari">PARIDAD</label>
                    <input id="pari" type="text" class="form-control " value="{{$gestante->paridad}}"/>
                    <div id="valpari"></div>
            ...
            <div class="col-xl-12 col-sm-12 col-xs-12 row ">
                <div class="col-xl-3 ">
                    ...
                    <input type="text" class="form-control " id="fecregla" onchange="fechaultimaRegla()"
                           autocomplete="off" value="{{$gestante->fecUltiRegla}}">
                    <div id="valfecregla"></div>
                </div>
                <div class="col-xl-3 ">
                    <label for="fecpart">FECHA PROBABLE PARTO </label>
                    <input id="fecpart" type="text" class="form-control " disabled value="{{$gestante->fecProbParto}}"/>
                </div>
            ...
            <div class="col-xl-12 text-center">
                ...
                <button id="enviar" class="btn btn-success " title="click para agregar usuario
                    " onclick="enviarEditar()"><i class="fas fa-lg fa-fw m-r-10 fa-save"></i>Guardar
                </button>
            </div>
        </div>
    </div>
...
<script>
    $.when(
        ...
        $.getScript('../js/intranet/util.js'),
            ...
            $.getScript('../js/intranet/gestantes/editarGestante.js'),
