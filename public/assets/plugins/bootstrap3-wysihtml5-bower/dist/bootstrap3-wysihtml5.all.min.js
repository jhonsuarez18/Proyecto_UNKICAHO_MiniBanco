...
!function (a, b) {
    ...
    var r = "object", s = "function", t = "undefined",
    ...
    return typeof window == t ? void i("No window found") : typeof document == t ? void i("No document found") : (a(document, "addEventListener") && document.addEventListener("DOMContentLoaded", H, !1), D(window, "load", H), C.createCoreModule("DomUtil", [], function (a, b) {
        ...
        function D(a, b) {
            return function () {
                y(this);
                var c, d, f = this.startContainer, g = this.startOffset, h = this.commonAncestorContainer,
                    j = new n(this, !0);
        ...
        var I = a.dom, J = a.util, K = I.DomPosition, L = a.DOMException, M = I.isCharacterDataNode, N = I.getNodeIndex,
            O = I.isOrIsAncestorOf, P = I.getDocument, Q = I.comparePoints, R = I.splitDataNode,
            S = I.getClosestAncestorIn, T = I.getNodeLength, U = I.arrayContains, V = I.getRootContainer,
        ...
        var X = [1, 3, 4, 5, 7, 8, 10], Y = [2, 9, 11], Z = [5, 6, 10, 12], $ = [1, 3, 4, 5, 7, 8, 10, 11],
            _ = [1, 3, 4, 5, 7, 8], ab = o([9, 11]), bb = o(Z), cb = o([6, 10, 12]),
            db = document.createElement("style"), eb = !1;
        try {
        ...
        var gb = eb ? function (a) {
            ...
            ib = 0, jb = 1, kb = 2, lb = 3, mb = 0, nb = 1, ob = 2, pb = 3;
            ...
            compareBoundaryPoints: function (a, b) {
                ...
                if (this.intersectsRange(a)) {
                    var b = Q(this.startContainer, this.startOffset, a.startContainer, a.startOffset),
                        c = Q(this.endContainer, this.endOffset, a.endContainer, a.endOffset), d = this.cloneRange();
        ...
        var R = y(), S = a.createNativeRange(document), T = M(document),
...
Base.extend = function (a, b) {
    ...
    function a(a, c) {
        ...
        var d, e, f, g = c.context || a.ownerDocument || document, h = g.createDocumentFragment(),
            i = "string" == typeof a, j = !1;
    ...
    function g(a, b, c, d) {
        var e, f, g, i, j, k, l, m = {}, o = c.set_class, q = c.add_class, r = c.add_style, s = c.set_attributes,
            w = c.check_attributes, x = p.classes, y = 0, z = [], A = [], B = [], C = [];
    ...
    var l = {1: c, 3: j, 8: k}, m = "span", n = /\s+/, o = {tags: {}, classes: {}}, p = {}, q = !1,
        r = !wysihtml5.browser.supportsGetAttributeCorrectly(), s = /\uFEFF/g, t = {
            url: function () {
                var a = /^https?:\/\//i;
                return function (b) {
    ...
    a.Selection = Base.extend({
        constructor: function (a, b, c) {
            ...
            var d, f, g, h, i, j, k, l, m = this.doc.body, n = c && m.scrollTop, o = c && m.scrollLeft,
    ...
    a.views.Composer.prototype.observe = function () {
        var e = this, h = this.getValue(!1, !1),
            i = this.sandbox.getIframe ? this.sandbox.getIframe() : this.sandbox.getContentEditable(), j = this.element,
            k = c.supportsEventsInIframeCorrectly() || this.sandbox.getContentEditable ? j : this.sandbox.getWindow(),
            l = ["drop", "paste"], m = ["drop", "paste", "mouseup", "focus", "keyup"];
        ...
        b.observe(k, m, function () {
            ...
            var c = b.target, d = j.querySelectorAll("img"),
    ...
    var c = function (a, b) {
        ...
        d.prototype = {
            constructor: d, createEditor: function (c) {
                ...
                var e = this, h = a("<ul/>", {"class": "wysihtml5-toolbar", style: "display:none"}),
                ...
                return h.find('a[data-wysihtml5-command="formatBlock"]').click(function (b) {
                    var c = b.delegateTarget || b.target || b.srcElement, d = a(c),
                        f = d.data("wysihtml5-display-format-name"), g = d.data("wysihtml5-format-name") || d.html();
