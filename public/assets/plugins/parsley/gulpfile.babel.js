...
function buildDoc(done) {
  ...
  docco.document({
    ...
    args: sources
      ...
      .pipe($.replace('<div id="jump_page">', '<div id="jump_page"><a class="source" href="../index_administrador.blade.php">&lt;&lt;&lt; back to documentation</a>'))
...
function gitPushPages() {
  $.git.push('origin', 'master:gh-pagina', err => { if (err) throw err });
}
